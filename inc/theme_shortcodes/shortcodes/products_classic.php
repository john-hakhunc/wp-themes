	...
	$html	=	'';
		...
		if( count( $rows ) > 0 )
		{
			...
			if( get_post_meta( $row['product'], 'package_free_ads', true ) != "" )
				$li .= '<li>'.__('Ads','adforest').': '.get_post_meta( $row['product'], 'package_free_ads', true ) .'</li>';
			if( get_post_meta( $row['product'], 'package_featured_ads', true ) != "" )
				$li .= '<li>'.__('Featured Ads','adforest').': '.get_post_meta( $row['product'], 'package_featured_ads', true ) .'</li>';
