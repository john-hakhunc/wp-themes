          ...
          <div class="row">
            ...
            ?> 
                   ...
                   <?php
					...
					{
						echo '<li><a href="'. esc_url( $adforest_theme['footer_android_app'] ) .'"><img src="' .  esc_url( trailingslashit( get_template_directory_uri () ) ) .'images/appstore.png" alt="'.__ ( 'Android App', 'adforest' ).'"></a></li>';
					}
				   	if( isset( $adforest_theme['footer_ios_app'] ) && $adforest_theme['footer_ios_app'] != "" )
					{
						echo '<li><a href="'. esc_url( $adforest_theme['footer_android_app'] ) .'"><img src="' .  esc_url( trailingslashit( get_template_directory_uri () ) ) .'images/googleplay.png" alt="'.__ ( 'IOS App', 'adforest' ).'"></a></li>';
					}
				   ?>
